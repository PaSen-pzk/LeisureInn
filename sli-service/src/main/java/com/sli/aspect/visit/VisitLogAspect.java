package com.sli.aspect.visit;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.sli.common.util.AddressUtil;
...
import static com.sli.common.util.DeviceUtil.isFromMobile;
...
public class VisitLogAspect {
    ...
    @Pointcut("@annotation(com.sli.aspect.visit.VisitLog)")
    ...
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        SliVisitLogDO sliVisitLogDO = SliVisitLogDO.builder().deviceType(isFromMobile(request) ? "手机" : "电脑").method(
        ...
        if (args != null && paramNames != null) {
            ...
            sliVisitLogDO.setParams(paramsJson);
        }
        long beginTime = System.currentTimeMillis();
        Object proceed = joinPoint.proceed();
        long end = System.currentTimeMillis();
        sliVisitLogDO.setTime((int)(end - beginTime));
        sliVisitLogRepository.save(sliVisitLogDO);
        return proceed;
    }
